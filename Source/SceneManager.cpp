...
// To set each of the shapes to turn on the light effection
void SceneManager::DefineObjectMaterials() {
	OBJECT_MATERIAL floorMaterial;
	floorMaterial.ambientColor = glm::vec3(0.2f, 0.2f, 0.2f);
	floorMaterial.ambientStrength = 0.4f;
	floorMaterial.diffuseColor = glm::vec3(0.3f, 0.3f, 0.2f);
	floorMaterial.specularColor = glm::vec3(0.6f, 0.5f, 0.4f);
	floorMaterial.shininess = 22.0;
	floorMaterial.tag = "floor";

	m_objectMaterials.push_back(floorMaterial);

	//OBJECT_MATERIAL cocoMaterial;
	//cocoMaterial.ambientColor = glm::vec3(0.2f, 0.2f, 0.2f);
	//cocoMaterial.ambientStrength = 0.4f;
	//cocoMaterial.diffuseColor = glm::vec3(0.3f, 0.3f, 0.2f);
	//cocoMaterial.specularColor = glm::vec3(0.6f, 0.5f, 0.4f);
	//cocoMaterial.shininess = 22.0;
	//cocoMaterial.tag = "cocnutwaterLight";

	//m_objectMaterials.push_back(cocoMaterial);

	OBJECT_MATERIAL baseballMaterial;
	baseballMaterial.ambientColor = glm::vec3(0.2f, 0.2f, 0.2f);
	baseballMaterial.ambientStrength = 0.4f;
	baseballMaterial.diffuseColor = glm::vec3(0.3f, 0.3f, 0.2f);
	baseballMaterial.specularColor = glm::vec3(0.6f, 0.5f, 0.4f);
	baseballMaterial.shininess = 22.0;
	baseballMaterial.tag = "baseballLight";

	m_objectMaterials.push_back(baseballMaterial);
	...
	glassMaterial.tag = "glassLight";

	m_objectMaterials.push_back(glassMaterial);

	//OBJECT_MATERIAL textbookMaterial;
	//textbookMaterial.ambientColor = glm::vec3(0.2f, 0.2f, 0.2f);
	//textbookMaterial.ambientStrength = 0.4f;
	//textbookMaterial.diffuseColor = glm::vec3(0.3f, 0.3f, 0.2f);
	//textbookMaterial.specularColor = glm::vec3(0.6f, 0.5f, 0.4f);
	//textbookMaterial.shininess = 22.0;
	//textbookMaterial.tag = "textbookLight";

	//m_objectMaterials.push_back(textbookMaterial);

	//OBJECT_MATERIAL canMaterial;
	//canMaterial.ambientColor = glm::vec3(0.2f, 0.2f, 0.2f);
	//canMaterial.ambientStrength = 0.4f;
	//canMaterial.diffuseColor = glm::vec3(0.3f, 0.3f, 0.2f);
	//canMaterial.specularColor = glm::vec3(0.6f, 0.5f, 0.4f);
	//canMaterial.shininess = 22.0;
	//canMaterial.tag = "cantopLight";

	//m_objectMaterials.push_back(canMaterial);

	//OBJECT_MATERIAL paperMaterial;
	//paperMaterial.ambientColor = glm::vec3(0.2f, 0.2f, 0.2f);
	//paperMaterial.ambientStrength = 0.4f;
	//paperMaterial.diffuseColor = glm::vec3(0.3f, 0.3f, 0.2f);
	//paperMaterial.specularColor = glm::vec3(0.6f, 0.5f, 0.4f);
	//paperMaterial.shininess = 22.0;
	//paperMaterial.tag = "paperLight";

	//m_objectMaterials.push_back(paperMaterial);
}

// SetupSceneLights() function will give more details and better 3D lights from each objects
void SceneManager::SetupSceneLights() {
	m_pShaderManager->setVec3Value("lightSources[0].position", 3.0f, 14.0f, 0.0f);
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", 0.01f, 0.01f, 0.04f);
	...
	m_pShaderManager->setFloatValue("lightSources[0].speclarIntensity", 0.05f);

	m_pShaderManager->setVec3Value("lightSources[1].position", -3.0f, 14.0f, 0.0f);
	m_pShaderManager->setVec3Value("lightSources[1].ambientColor", 0.01f, 0.01f, 0.04f);
	...
	m_pShaderManager->setFloatValue("lightSources[1].speclarIntensity", 0.05f);
	...
	m_pShaderManager->setFloatValue("lightSources[2].speclarIntensity", 0.05f);

	m_pShaderManager->setVec3Value("lightSources[3].position", -0.6f, 5.0f, 6.0f);
	m_pShaderManager->setVec3Value("lightSources[3].ambientColor", 0.01f, 0.01f, 0.04f);
	...
	m_pShaderManager->setFloatValue("lightSources[3].speclarIntensity", 0.05f);
...
/* LoadSceneTextures()
	...
	This method will display each of the images as textures
...
void SceneManager::PrepareScene()
{
	...
	// using the LoadSceneTexture() function to display it with using the PrepareScene function
	LoadSceneTextures();
	// the two functions below will support the light effection to display
...
void SceneManager::RenderScene()
{
	...
	SetShaderColor(0.929, 0.714, 0.714, 1);
	SetShaderMaterial("baseballLight");

	// draw the mesh with transformation values
	m_basicMeshes->DrawSphereMesh();
	/****************************************************************/

	// TAPERED CYLINDER SHAPE (GLASS CUP)
	...
	SetShaderColor(0, 0.325, 0, 1);
	SetShaderMaterial("glassLight");
